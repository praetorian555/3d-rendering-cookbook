...
void Run()
{
    ...
    render_solid_command_list.Update(per_frame_buffer, Opal::AsBytes(per_frame_data));
    ...
    render_wireframe_command_list.Update(per_frame_buffer, Opal::AsBytes(per_frame_data));
